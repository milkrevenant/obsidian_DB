...
6. '주제통합적 독서'문항들은 대체로 수능 독서 문항들 중 2지문이 엮여 있는 문항들에서 출제되는 문항인데 시간도 오래걸리는 편이고, 선택지도 짧지 않아서 해석이 오래걸리는 글들이다. 예를 들면 이런 문항들이 있다. 역시 이런 문항들을 먼저 '텍스트'들로 바꿔주는 작업을 하고, 그 문제들에 대해 학습을 시키고, 이런 형태의 문제들을 만들어달라고 요구를 하게 되면, 그런 요구를 최대한 반영시켜주는 결과들을 불러와준다. 
8. 
9. 
