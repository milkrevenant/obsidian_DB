...
5. 선택형 문항은 내가 넣지 않았고, 서답형 문항만 넣어놨다. 이렇게 정리해보면 결국 프롬프트를 어떻게 집어넣느냐의 싸움이 되어버린다. 대충 독서는 이 정도면 아주 기초적인 문제들을 만드는 수준까지는 왔다. 하지만 사실 더 중요한 건 글을 이해하는 과정에서의 설명자료가 필요하다. 그걸 도출해보는 프롬프트로 넘어가자.
